  ...
  return (
    <div className="hero_section">
      <div className="overlay">
        <div>
          <h1 className="text-green-800 text-8xl sm:text-5xl font-bold">
            GP 221
          </h1>
          <p className="font-semibold text-2xl py-5">
            Votre colis, notre mission, partout au Sénégal
          </p>
          <div className="flex sm:flex-col gap-5 ">
            <button className="relative flex items-center px-6 py-3 overflow-hidden font-medium transition-all bg-red-500 rounded-md group">
              ...
              <span className="relative w-full font-bold text-left text-white transition-colors duration-200 ease-in-out group-hover:text-white">
                Voir la liste de nos GP
              </span>
            </button>
            <button className="border-2 px-6 py-4 text-black font-bold rounded-md border-red-800 bg-transparent hover:bg-red-800 hover:text-white">
              Qui somme nous ?
            </button>
          </div>
        </div>
